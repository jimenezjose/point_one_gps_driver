...
#include "atlas_gps_driver/atlas.hpp"

/*
 * Point One Nav Atlas Node publishes realtime GPS/IMU messages.
 */ 
...
public:
  AtlasNode() : 
    ...
    timer_ = create_wall_timer(std::chrono::milliseconds(1), std::bind(&AtlasNode::serviceLoopCb, this));
